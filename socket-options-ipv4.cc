...
//
  ...
  InetSocketAddress remote4 = InetSocketAddress (i.GetAddress (4), 4477);
  ...
  AnimationInterface anim ("Socket-v4.xml");

  anim.SetConstantPosition(n.Get(0),0.0,0.0);
  anim.SetConstantPosition(n.Get(1),1.0,2.0);
 anim.SetConstantPosition(n.Get(2),1.5,2.0);
  anim.SetConstantPosition(n.Get(3),0.5,1.0);
 anim.SetConstantPosition(n.Get(4),1.0,1.0);
